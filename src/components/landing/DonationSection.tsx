    ...
    <section id="infaq" className="w-full py-16 sm:py-24 bg-slate-100/80 dark:bg-slate-950 border-y border-slate-200/70 dark:border-slate-800/80 transition-colors scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-700 space-y-2">
              <div className="flex justify-between text-xs font-semibold">
                <span className="text-slate-600 dark:text-slate-300">Estimasi Kebutuhan Acara</span>
          ...
          <div className="lg:col-span-7 bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-8 border border-slate-100 dark:border-slate-700 shadow-md space-y-6">
            <div>
                ...
                <button
                  ...
                  className={`py-2 px-1 rounded-xl text-xs font-bold transition border text-center ${
                    selectedAmount === amt && !customAmount
                      ...
                      : "bg-slate-50 dark:bg-slate-700 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-600 hover:border-brand-emerald"
                  }`}
                >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-emerald"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2.5">
                {bankAccounts.map((acc) => (
                  <div
                    key={acc.bank}
                    className="p-3.5 rounded-2xl border border-slate-200/80 dark:border-slate-700 bg-brand-cardBg/60 dark:bg-slate-900 flex items-center justify-between gap-3"
                  >
                    <div>
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-brand-accentLight/60 dark:hover:bg-slate-700 transition flex items-center gap-1.5 shrink-0 shadow-2xs"
                    >
                      {copiedBank === acc.bank ? (
                        <>
